...
router.post('/addProduct', (req, res) => {
    ...
    let decodedToken = jwt_decode(token);
    const vendor_id = decodedToken['result']['_id'];
    const {title, description, slug, sku, regular_price, discount_price, quantity, status, image, categoryName, occasionName} = req.body;
...
router.post('/editProduct', (req, res) => {
    const {id, title, description, slug, sku, regular_price, discount_price, quantity, status, image, categoryName, occasionName} = req.body;
